...
namespace Lean.Transition
{
	...
	public class LeanTransition : MonoBehaviour
	{
		...
		/// <summary>If you want to change the update timing of the transitions in this animation then you can specify it here.</summary>
		...
		/// <summary>This will return an update mode that isn't default.</summary>
		...
		/// <summary>This will return an update mode that isn't unscaled.</summary>
		public static LeanTime GetTimingAbs(LeanTime current)
		{
			return (LeanTime)System.Math.Abs((int)current);
		}

		/// <summary>If you failed to submit a previous transitions then this will throw an error, and then submit them.</summary>
		...
		/// <summary>This method returns all TargetAliases on all transitions on the specified GameObject.</summary>
